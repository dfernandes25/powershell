<#
    ...
    .SYNOPSYS
    Creates csv and html reports with MFA and password state
...
$Version = "1.3"
$CSVOutputFile = "~/Desktop/dev/m365Pros/UserAuthenticationReport.csv"
$ReportFile = "~/Desktop/dev/m365Pros/UserAuthenticationReport.html"
